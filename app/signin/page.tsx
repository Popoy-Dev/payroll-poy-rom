  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 dark:from-neutral-900 dark:to-neutral-800 flex items-center justify-center">
      <div className="w-full max-w-md p-10 rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800">
        <h2 className="text-3xl mb-6 font-extrabold text-center text-blue-900 dark:text-blue-300">Sign in to your account</h2>
        <form onSubmit={handleSignin} className="flex flex-col gap-5">
          ...
          {success && <div className="text-green-600 text-center">Signed in successfully!</div>}
        </form>
        <div className="mt-6 text-center text-gray-600 dark:text-gray-300">
          Don&apos;t have an account?{' '}
          <Link href="/signup" className="text-blue-700 hover:underline dark:text-blue-300">Sign up</Link>
        </div>
      </div>
    </div>
  )
