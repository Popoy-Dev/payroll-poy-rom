    ...
    <div className="min-h-screen flex bg-gradient-to-br from-blue-50 to-gray-100 dark:from-neutral-900 dark:to-neutral-800">
      ...
      <aside className="w-64 bg-white dark:bg-neutral-900 border-r border-gray-200 dark:border-neutral-800 flex flex-col p-6 gap-6 shadow-lg">
        ...
        <nav className="flex flex-col gap-3">
          ...
          <Link href="/admin/dashboard/employees" className="px-4 py-2 rounded-lg hover:bg-blue-100 dark:hover:bg-neutral-800 text-blue-900 dark:text-blue-200 font-medium transition">Employees</Link>
          <Link href="/admin/dashboard/payroll" className="px-4 py-2 rounded-lg hover:bg-blue-100 dark:hover:bg-neutral-800 text-blue-900 dark:text-blue-200 font-medium transition">Payroll</Link>
        </nav>
